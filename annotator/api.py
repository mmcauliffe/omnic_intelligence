...
class HeroViewSet(viewsets.ModelViewSet):
    model = models.Hero
    queryset = models.Hero.objects.filter(~Q(name='brigitte')).all()
...
class TrainRoundPlusViewSet(viewsets.ModelViewSet):
    model = models.Round
    queryset = models.Round.objects.filter(~Q(game__match__wl_id=2418)).filter(
...
class RoundViewSet(viewsets.ModelViewSet):
    ...
    def update(self, request, *args, **kwargs):
        ...
        if abs(begin_shift) >= min_shift:
            ...
            instance.pause_set.update(time_point=F('time_point') - begin_shift)
            instance.unpause_set.update(time_point=F('time_point') - begin_shift)
            instance.replaystart_set.update(time_point=F('time_point') - begin_shift)
            instance.replayend_set.update(time_point=F('time_point') - begin_shift)
            instance.smallerwindowstart_set.update(time_point=F('time_point') - begin_shift)
            instance.smallerwindowend_set.update(time_point=F('time_point') - begin_shift)
            ...
            instance.overtimestart_set.update(time_point=F('time_point') - begin_shift)
            instance.overtimeend_set.update(time_point=F('time_point') - begin_shift)
    ...
    @detail_route(methods=['get'])
    def overtime_starts(self, request, pk=None):
        round = self.get_object()
    ...
    @detail_route(methods=['get'])
    def overtime_ends(self, request, pk=None):
        round = self.get_object()
        overtimeends = round.overtimeend_set.all()
        serializer = serializers.OvertimeEndSerializer(overtimeends, many=True)
        return Response(serializer.data)

    @detail_route(methods=['get'])
    def replay_starts(self, request, pk=None):
        round = self.get_object()
    ...
    @detail_route(methods=['get'])
    def replay_ends(self, request, pk=None):
        round = self.get_object()
    ...
    @detail_route(methods=['get'])
    def smaller_window_starts(self, request, pk=None):
        round = self.get_object()
        replaystarts = round.smallerwindowstart_set.all()
        serializer = serializers.SmallerWindowStartSerializer(replaystarts, many=True)
        return Response(serializer.data)

    @detail_route(methods=['get'])
    def smaller_window_ends(self, request, pk=None):
        round = self.get_object()
        replayends = round.smallerwindowend_set.all()
        serializer = serializers.SmallerWindowEndSerializer(replayends, many=True)
        return Response(serializer.data)
...
class UnpauseViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        request.data['time_point'] = round(request.data['time_point'], 1)
        return super(UnpauseViewSet, self).create(request, *args, **kwargs)
...
class ReplayStartViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        request.data['time_point'] = round(request.data['time_point'], 1)
        return super(ReplayStartViewSet, self).create(request, *args, **kwargs)
...
class ReplayEndViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        request.data['time_point'] = round(request.data['time_point'], 1)
        return super(ReplayEndViewSet, self).create(request, *args, **kwargs)
...
class OvertimeStartViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        request.data['time_point'] = round(request.data['time_point'], 1)
        return super(OvertimeStartViewSet, self).create(request, *args, **kwargs)
...
class OvertimeEndViewSet(viewsets.ModelViewSet):
    model = models.OvertimeEnd
    queryset = models.OvertimeEnd.objects.all()
    serializer_class = serializers.OvertimeEndSerializer

    def create(self, request, *args, **kwargs):
        request.data['time_point'] = round(request.data['time_point'], 1)
        return super(OvertimeEndViewSet, self).create(request, *args, **kwargs)
...
class SmallerWindowStartViewSet(viewsets.ModelViewSet):
    model = models.SmallerWindowStart
    queryset = models.SmallerWindowStart.objects.all()
    serializer_class = serializers.SmallerWindowStartSerializer

    def create(self, request, *args, **kwargs):
        request.data['time_point'] = round(request.data['time_point'], 1)
        return super(SmallerWindowStartViewSet, self).create(request, *args, **kwargs)
...
class SmallerWindowEndViewSet(viewsets.ModelViewSet):
    model = models.SmallerWindowEnd
    queryset = models.SmallerWindowEnd.objects.all()
    serializer_class = serializers.SmallerWindowEndSerializer

    def create(self, request, *args, **kwargs):
        request.data['time_point'] = round(request.data['time_point'], 1)
        return super(SmallerWindowEndViewSet, self).create(request, *args, **kwargs)
