<template>
    ...
    <v-flex>
        ...
        <v-select :items="event_types"
                  label="Event type" v-model="filters.event_type" item-text="name" item-value="id">
        </v-select>
        <v-select :items="selected_types" clearable
                  label="Sub type" v-model="filters.type_id" item-text="name" item-value="id">
        </v-select>
...
<script>
    ...
    export default {
        ...
        data: () => ({
            title: 'Broadcast event search | Omnic Intelligence',
            selected: [],
            event_types: [
                {id: 'pause', name: 'Pause'},
                {id: 'replay', name: 'Replay'},
                {id: 'smaller_window', name: 'Smaller window'},
                ],
            filters: {},
            headers: [
        ...
        computed: {
            ...
            selected_types(){
                if (this.filters.event_type === 'pause'){
                    return this.pause_types
                }
                else if (this.filters.event_type === 'replay'){
                    return this.replay_types
                }
                else if (this.filters.event_type === 'smaller_window'){
                    return this.smaller_window_types
                }
            },
            loading() {
        ...
        methods: {
            ...
            ...mapActions('rounds', {
                getBroadcastEventRounds: 'getBroadcastEventRounds',
            ...
            ...mapActions('overwatch', {
                ...
                getReplayTypes: 'getReplayTypes',
                getSmallerWindowTypes: 'getSmallerWindowTypes',
            }),
            ...mapActions('vods', {
            ...
            refresh(){
                ...
                this.getBroadcastEventRounds(params);
            }
        },
        watch: {
            pagination: {
