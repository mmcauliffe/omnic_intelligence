<template>
    <div>
        ...
        <v-layout layout="row" layout-align="space-between start" v-if="can_edit">
            ...
            <v-btn class='primary raised' v-on:click="addEvent">Add overtime</v-btn>
        </v-layout>
        <v-data-table :headers="headers" :items="overtimes" v-if="overtimes" :rows-per-page-items="rowsPerPage">
