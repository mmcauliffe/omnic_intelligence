        ...
        <v-data-table :headers="headers" :items="kill_feed_events" v-if="kill_feed_events" :rows-per-page-items="rowsPerPage">
            ...
            <template slot="items" slot-scope="props">
                ...
                <td>
                    ...
                    && props.item.killing_player && playerOnLeftTeam(props.item.dying_player)"
                ...
                <td>
                    ...
                    <div v-else-if="props.item.killing_player && props.item.ability">
                ...
                <td>
                    ...
                    <div v-if="props.item.denied_ult">
