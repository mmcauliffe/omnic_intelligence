<template>
    <div>
        ...
        <v-layout layout="row" layout-align="space-between start" v-if="can_edit">
            ...
            <v-btn class='primary raised' v-on:click="addEvent">Add ult gain</v-btn>
        </v-layout>
        <v-data-table :headers="headers" :items="ult_gains" v-if="ult_gains" :rows-per-page-items="rowsPerPage">
